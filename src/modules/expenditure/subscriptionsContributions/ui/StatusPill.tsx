...
export function StatusPill({ value }: { value: string }) {
  ...
  else if (isUnderValidationStatus(v)) cls = "bg-fuchsia-100 text-fuchsia-700";
  ...
  else if (isInactiveStatus(v)) cls = "bg-slate-200 text-slate-700";
