/* PageHeader — SOE & Fund Transfer Management banner with PRN 6.2 breadcrumb. */
        ...
        <div className="min-w-0 flex-1 space-y-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">
              SOE &amp; Fund Transfer Management
            </h1>
            <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-600">
              Capture intra/inter-agency fund transfers, attach the supporting
              Statement-of-Expenditure lines, run the SRS-mandated validation
              rules, drive the Parliament-sanctioned approval chain, release
              funds via the core banking or Meridian channels, and reconcile
              each release against bank statements.
            </p>
          </div>
        </div>
        {showBack && (
