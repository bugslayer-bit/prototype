/* Reusable confirmation modal (mirrors the Utility/InvoiceBill pattern). */
...
export function ConfirmDialog({
  ...
  return (
    <div role="dialog" aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full max-w-md overflow-hidden rounded-[28px] bg-white shadow-2xl ring-1 ${styles.ring}`}>
        <div className="h-1.5 w-full bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900" />
        <div className="px-6 pt-6 pb-2">
          <div className="flex items-start gap-4">
            <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl text-xl font-bold shadow-lg ${styles.iconBg}`}>
              {styles.icon}
            </div>
