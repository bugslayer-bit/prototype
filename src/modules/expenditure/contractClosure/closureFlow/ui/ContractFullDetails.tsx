/* ContractFullDetails — collapsible panel that shows every single field of
   the selected StoredContract by reusing the infrastructure already built
   for the Contract Lifecycle page (ContractIdentityStrip +
   ContractSnapshotPanel). Keeps the two modules in sync automatically. */
