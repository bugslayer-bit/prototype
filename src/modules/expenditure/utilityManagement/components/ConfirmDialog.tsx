/* Reusable confirmation modal for Utility Management (mirrors pattern used
   across Expenditure modules). */
...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-w-md overflow-hidden rounded-[28px] bg-white shadow-2xl ring-1 ${styles.ring}`}
      >
        ...
        <div className="px-6 pt-6 pb-2">
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <span
                className={`inline-block rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider ${styles.chip}`}
              >
                Confirm Action
              </span>
